...
public class ejercicio3p13 {
	...
	public static void main(String[] args) {
		/*
		 * Ejercicio 3.13: Escribe un programa que incremente la hora de un reloj. Se
		 * pedirán por teclado la hora, minutos y segundos, asi como cuantos segundos se
		 * desea incrementar la hora introducida. La aplicacion mostrará la nueva hora.
		 */
		...
		System.out.println("La hora corregida: " + ((hours % 24) + (minutes / 60)) + ":"
				+ ((minutes % 60) + (seconds / 60)) + ":" + (seconds % 60));
		...
		System.out.println("The resulting hour is: " + (hours % 24) + ":" + minutes + ":" + seconds);
